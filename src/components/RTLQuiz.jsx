...
const getRandomQuestions = () => {
  const shuffledQuestions = [...rtlQuizzes].sort(() => Math.random() - 0.5);
  ...
  return (
    <div className="max-w-lg mx-auto p-6 bg-white shadow-xl rounded-lg mt-10">
      <header className="text-center mb-6">
        <h1 className="text-3xl text-blue-600 font-semibold">React Testing Library Quiz</h1>
